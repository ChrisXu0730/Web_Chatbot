...
<h1 class="center" id="headline">
  <a href="http://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html">
    Chatbot System</a> for car drivers</h1>
<div id="info">
...
function texttospeech(dialog){
    ...
    for(var i = 0; i < voices.length; i++ ) {
	   ...
	   var showText ="Sorry, Driver. I don't understand";
	   var sayText ="Sorry, Driver. I don't understand";
...
//Default answer
	   ...
	   {	
	   		showText = sayText = "This is the demostration to show you how to combine web speech API and GPS API.";
          ...
          else if(dialog=="search nearby restaurant"){
                 var x = document.getElementById("demo");
                 getRestaurant();
                 showText = "I am checking the restaurants near your location, wait a minute";
                 sayText=showText;
}


else if(dialog.indexOf("crawling")!=-1 ){
                  $.ajaxSetup({async: false});
                  showText="";
                  sayText="";
...
else if(dialog=="recommend some diners for me"){
                  $.ajaxSetup({async: false});
                  showText="";
                  sayText="";
 
                  $.ajax({
                  url: "recommend_restaurant.php",
                  data: {text: dialog},
                  success: function (data) {
                         showText=data;
                         sayText=data;
...
else if(dialog=="recommend some hotels for me"){
                  $.ajaxSetup({async: false});
                  showText="";
                  sayText="";
 
                  $.ajax({
                  url: "recommend_hotel.php",
                  data: {text: dialog},
                  success: function (data) {
                         showText=data;
                         sayText=data;
...
else if(dialog.indexOf("website")!=-1 ){
                  $.ajaxSetup({async: false});
                  showText="";
                  sayText="";
...
else if(phrase.indexOf("restaurant")!=-1 ){
                 var x = document.getElementById("demo");
                 getRestaurant();
				 showText="The noun phrases are : <span style='color:blue'>"+phrase+"</span>";
                 sayText="The noun phrases are"+ phrase;
                 showText += "I am checking the restaurants near your location, wait a minute";
                 sayText=showText;
}
...
//Welcome Speech
	var welcomeStr = "Hello Driver, welcome to use the chatbot system.";
...
function saysomething(str) {
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA44yBOVy9LHYKMlJEBHHx9IroSB6AeSOg
...
function getRestaurant() {
 if (navigator.geolocation) {
 navigator.geolocation.getCurrentPosition(showRestaurant);
 } else { 
 x.innerHTML = "Geolocation is not supported by this browser.";
 }
}
function showRestaurant(position) {
